-- Page-level star ratings, collected directly from site visitors on each
-- content page. Deliberately separate from any third-party review source
-- (e.g. Google Business Profile) — this table only ever contains votes cast
-- by visitors on the page itself, starting from zero.
