...
const privateAppraiserAnswer = `<section class="rr-video-summary rr-direct-answer" aria-label="מתי צריך שמאי רכוש פרטי">
  <h2>מתי צריך שמאי רכוש פרטי?</h2>
  <p><strong>התשובה הקצרה:</strong> שמאי רכוש פרטי מתאים כאשר נדרש תיעוד עצמאי של נזק, הערכת עלויות או חוות דעת מטעם בעל הנכס או המבוטח, במיוחד לפני תיקון משמעותי או כשקיימת מחלוקת על היקף הנזק.</p>
  <ul>
    <li><strong>נזקי מים ורטיבות:</strong> הצפה, נזילה, רטיבות בתקרה או חשש לנזק נסתר במבנה.</li>
    <li><strong>נזקי אש ופיח:</strong> הערכת פגיעה במבנה, בתכולה, במערכות ובעלויות השיקום.</li>
    <li><strong>פריצה או נזק לרכוש:</strong> תיעוד פריטים שנפגעו או נגנבו והכנת אומדן מסודר.</li>
    <li><strong>מחלוקת מול חברת הביטוח:</strong> כאשר ההצעה אינה משקפת לדעתכם את היקף הנזק או תנאי הפוליסה.</li>
  </ul>
