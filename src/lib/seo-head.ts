...
export function augmentExpertSeo(
  ...
  try {
    ...
    if (
      ...
      const pageUrl = "https://www.rrshamaut.co.il/movie/moisture-test-standard-insurance-responsibility/";
      const videoId = "J9cy9XTCUeQ";
      graph.unshift({
        "@type": "VideoObject",
        "@id": `${pageUrl}#video`,
        name: "בדיקת לחות מתחת לריצוף – שיטה, תקן ואחריות",
        description:
          "הסבר מקצועי על מיפוי, דיגום ובדיקת לחות מתחת לריצוף ועל חלוקת התפקידים בתביעת נזקי מים.",
        thumbnailUrl: `https://i.ytimg.com/vi/${videoId}/maxresdefault.jpg`,
        embedUrl: `https://www.youtube.com/embed/${videoId}`,
        contentUrl: `https://www.youtube.com/watch?v=${videoId}`,
        inLanguage: "he-IL",
    ...
    const relatedLinks: Record<string, string[]> = {
      ...
      "ערכי-כינון-ערכי-שיפוי-הסבר-מלא": [
        "https://www.rrshamaut.co.il/movie/reinstatement-value-vs-indemnity-value/",
        "https://www.rrshamaut.co.il/הסבר-על-הליך-תביעת-ביטוח-בנזקי-מים-שלב/",
        "https://www.rrshamaut.co.il/ייעוץ-וליווי-תביעות-ביטוח/",
      ],
      "תביעת-נזקי-הצפה": [
      ...
      "jobs": [
        "https://www.rrshamaut.co.il/שמאי-רכוש-מחיר-כל-מה-שצריך-לדעת-על-אופן/",
        "https://www.rrshamaut.co.il/שמאי-רכוש-לנזקים-והערכות-שווי-תפקיד-עב/",
        "https://www.rrshamaut.co.il/about/",
      ],
      "שמאי-רכוש-מחיר-כל-מה-שצריך-לדעת-על-אופן": [
        "https://www.rrshamaut.co.il/jobs/",
        "https://www.rrshamaut.co.il/הבדל-בין-שמאי-רכוש-פרטי-לשמאי-רכוש-מטעם/",
        "https://www.rrshamaut.co.il/כל-מה-שחשוב-לדעת-על-דוח-שמאות-רכוש/",
      ],
      ...
      "שמאי-נזקי-מים-המדריך-המלא": [
        "https://www.rrshamaut.co.il/נזקי-מים-הצפה-ורטיבות/",
        "https://www.rrshamaut.co.il/שמאי-נזקי-הצפה-כל-מה-שצריך-לדעת-שמאי-רכו/",
      ...
      "שאלות-תשובות": [
        "https://www.rrshamaut.co.il/תביעת-ביטוח-נזקי-צנרת-מדריך-מקיף-לתהלי/",
        "https://www.rrshamaut.co.il/נזקי-מים-הצפה-ורטיבות/",
        "https://www.rrshamaut.co.il/movie/plumbing-damage-new-apartment-insurance-vs-contractor/",
      ],
    };
    ...
    if (normalizedPath === "שאלות-תשובות") {
      ...
      if (faqPage) {
        const entities = Array.isArray(faqPage.mainEntity)
          ? (faqPage.mainEntity as Array<Record<string, unknown>>)
          : [];
        const answerFor = (entity: Record<string, unknown>, text: string) => {
          entity.acceptedAnswer = { "@type": "Answer", text };
        };
        const corrections = new Map<string, string>([
          [
            "האם נזילת מים מהווה תקרית המכוסה בפוליסת הביטוח לנזקי מים?",
            "נזק מהימלטות מים או נוזלים מצנרת עשוי להיות מכוסה אם נרכש הכיסוי הרלוונטי, הוא היה בתוקף והאירוע עומד בהגדרות הפוליסה. יש לבדוק בנפרד את תיקון מקור הכשל, נזקי המבנה והתכולה, השתתפות עצמית, כתב שירות והחרגות; הכיסוי והתשלום אינם אוטומטיים.",
          ],
          [
            "בית פרטי בן 3 קומות - אנו סבורים כי קיימת נזילה מצינור ניקוז אמבטיה. נגרם נזק לטייח ולצבע של תקרה בקומה התחתונה. האם האירוע יוכר והנזקים יכוסו תחת ההרחבה של נזקי מים בפוליסת הביטוח?",
            "תחילה מאתרים ומתעדים את מקור הנזילה ובודקים את הפוליסה והרשימה. כיסוי אפשרי תלוי בכך שהאירוע נכלל בהרחבת נזקי המים ובתנאים, בהחרגות ובהשתתפות העצמית; אין להסיק כיסוי רק מכך שהצינור נמצא בנכס. שומרים דוח איתור, תמונות ומדידות לפני תיקון נרחב.",
          ],
          [
            "האם ביטוח צנרת המבנה מכסה מקרה נזק של דליפת מים/ פיצוץ מצנרת הביוב בעקבות חדירת שורשים ?",
            "יש לבדוק את נוסח הכיסוי והחרגותיו: הפוליסה עשויה להבחין בין תיקון הצינור או סיבת הכשל לבין נזק מים שנגרם למבנה ולתכולה. חדירת שורשים, בלאי, תחזוקה או נזק הדרגתי עשויים להשפיע על הכיסוי, ולכן נדרשים דוח איתור, תיעוד ובדיקת הפוליסה; אין כיסוי מלא אוטומטי.",
          ],
          [
            "האם נזילת מים מצנרת גמישה השייכת לתמי 4 מכוסה במסגרת נזק צנרת בפוליסה?",
            "הכיסוי תלוי בהגדרת מתקני הצנרת והציוד בפוליסה, במקור הנזילה ובהחרגות. בודקים בנפרד את המכשיר והצינור הגמיש, נזקי המבנה והתכולה, ההשתתפות העצמית וכתב השירות; עצם השתייכות הצינור לדירה אינה מבטיחה כיסוי או תשלום.",
          ],
          [
            "עכבר אכל לי את הצנרת של הבית וכתוצאה מכך יש לי נזילת מים , האם הנזק בכיסוי ביטוחי?",
            "יש לבדוק את מקור הכשל, הכיסוי לנזקי מים והחרגות אפשריות לבעלי חיים, תחזוקה או נזק הדרגתי. ייתכן שהפוליסה תבחין בין תיקון הצינור לבין הנזק שנגרם מהמים; הכיסוי והתשלום נקבעים לפי הנוסח, הממצאים והראיות ואינם מובטחים.",
          ],
        ]);
        for (const entity of entities) {
          const replacement = corrections.get(String(entity.name ?? ""));
          if (replacement) answerFor(entity, replacement);
        }
        const question = "האם ביטוח דירה מכסה נזקי צנרת?";
        if (!entities.some((entity) => entity.name === question)) {
          entities.unshift({
            "@type": "Question",
            name: question,
            acceptedAnswer: {
              "@type": "Answer",
              text: "ביטוח דירה עשוי לכסות נזק שנגרם מהימלטות מים או נוזלים מצנרת אם הכיסוי היה בתוקף והאירוע עומד בתנאי הפוליסה. בודקים בנפרד את תיקון מקור הכשל, נזקי המבנה והתכולה, בחירת שרברב, השתתפות עצמית והחרגות. שומרים דוח איתור, תמונות, מדידות וחשבוניות; הכיסוי והתשלום אינם אוטומטיים.",
            },
          });
          faqPage.mainEntity = entities;
        }
    ...
    const serviceFaq = normalizedPath === "damage-to-electrical-systems"
      ...
      : normalizedPath === "ערכי-כינון-ערכי-שיפוי-הסבר-מלא"
        ? {
            question: "מה ההבדל בין ערך כינון לערך שיפוי?",
            answer: "ערך שיפוי משקף בדרך כלל את שווי הרכוש במועד הנזק בהתחשב בגיל, מצב ובלאי; ערך כינון משקף עלות תיקון או החלפה ברכוש מאותו סוג ואיכות, בכפוף לפוליסה. לדוגמה, עלות החלפה של 10,000 ₪ ושיפוי של 6,000 ₪ עשויות ליצור יתרת כינון של עד 4,000 ₪, אך התשלום בפועל תלוי בהוצאה, בסכום הביטוח, במועדים, במסמכים וביתר התנאים ואינו מובטח.",
          }
      : normalizedPath === "תביעת-נזקי-הצפה"
        ? {
            question: "מה עושים מיד אחרי הצפת מים בבניין?",
            answer: "מרחיקים אנשים ממים, חשמל, מעלית ואזורים לא בטוחים; אין להיכנס למים, לגעת בלוח או להפעיל מעלית. לאחר עצירת המקור השיקום כולל שאיבה בטוחה, מיפוי לחות, ייבוש ובקרה, ניקוי או טיפול בזיהום ורק אז תיקוני גמר. מתעדים לפני פינוי ושומרים דוחות וקריאות מעקב. צביעה לפני ייבוש עלולה להסתיר נזק. האחריות, הכיסוי והפיצוי תלויים בממצאים, בדין ובפוליסות ואינם מובטחים.",
          }
      : normalizedPath === "movie/fire-damage-without-insurance-can-you-get-compensation"
        ? {
      ...
      : normalizedPath === "jobs"
        ? {
            ...
            answer: "אין משכורת אחידה. שכר שכיר תלוי בניסיון, הכשרה, היקף משרה, אחריות, סוג תיקים, אזור, מעסיק ותנאים; הכנסה של עצמאי תלויה גם במספר תיקים, תמחור, הוצאות, גבייה ומסים. שכר טרחה מלקוח אינו משכורת ואינו משקף הכנסה נטו. נכון ל־17 באוגוסט 2026 עמוד הדרושים מציג שאין גיוס חדש, ולכן אין כאן משרה או טווח שכר מוצעים.",
          }
      : normalizedPath === "שמאי-רכוש-מחיר-כל-מה-שצריך-לדעת-על-אופן"
        ? {
            question: "כמה עולה שמאי רכוש ומה משפיע על שכר הטרחה?",
            answer: "אין מחירון אחיד לכל תיק. המחיר תלוי בסוג והיקף הנזק, מספר ביקורים ואתרים, כמות מסמכים, תכולה, בעלי מקצוע נוספים, דחיפות, נסיעות, מורכבות והתוצרים שנכללו במינוי. מבקשים הצעה כתובה עם היקף, הוצאות, מע״מ ותנאים. החזר מהמבטחת תלוי בפוליסה, בצורך, בסבירות ובמסמכים ואינו אוטומטי או מובטח.",
          }
        ...
        : normalizedPath === "נזקי-מים-עליה-קפילארית-כיצד-לפעול"
          ...
          : normalizedPath === "שמאי-נזקי-שריפה-מה-נכון-לעשות-כאשר-נגרם"
            ? {
                ...
                answer: "מזמינים שמאי נזקי שריפה לאחר שהזירה בטוחה לכניסה ולפני פינוי או שיקום נרחב. השמאי מתעד ומכמת נזקי מבנה, תכולה, עשן, פיח, חום ומי כיבוי ומכין חוות דעת מנומקת לתביעת הביטוח. הכיסוי וסכום התשלום נקבעים לפי הפוליסה, העובדות והראיות ואינם מובטחים.",
              }
          ...
          : normalizedPath === "שמאי-נזקי-הצפה-כל-מה-שצריך-לדעת-שמאי-רכו"
            ? {
                ...
                answer: "שמאי הצפות ונזקי הצפה ממפה ומתעד את היקף המים והרטיבות, בודק נזקי מבנה ותכולה, מעריך עלויות שאיבה, ייבוש ושיקום ומכין חוות דעת לתביעת הביטוח. מומלץ להזמינו לאחר עצירת סכנה מיידית ולפני פינוי או שיקום משמעותיים, תוך שמירת תמונות, מדידות, דוחות וחשבוניות. הכיסוי, האחריות וסכום התשלום תלויים במקור ההצפה, בפוליסה ובראיות ואינם מובטחים.",
              }
